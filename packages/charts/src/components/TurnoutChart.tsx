...
export default function TurnoutChart({
  ...
  return (
    <ChartFrame
      ...
      note="Lines break across gaps in the record (Midterm: no 1958–1962 turnout). 1917–1945 specials and municipals reuse the nearest general's registration (approximate). Sources: SF Municipal Reports Registrar tables (1879–1916); DOE turnout table; certified per-release finals."
    >
