...
export default function TurnoutChart({
  ...
  return (
    <ChartFrame
      ...
      note="Color = election type; generals split into presidential years (General, ~80–90%) and the even off-years (Midterm, ~60–70%) — lumped together they zigzag between the two cadences. Lines break across multi-decade gaps; the Midterm line breaks over the missing 1958–1962 turnout. Use the filter to add or remove types. Sources: SF Municipal Reports Registrar tables (1879–1907); DOE turnout table; certified per-release finals."
    >
