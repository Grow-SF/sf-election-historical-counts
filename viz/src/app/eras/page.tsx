...
export const metadata = {
  ...
  description:
    "What the morning-after newspaper knew, 1892–2026 — and why 'we don't know yet' has meant three completely different things.",
};
  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-14">
      ...
      <p className="mt-4 max-w-2xl text-lg italic leading-relaxed text-ink/70">
        What the morning-after newspaper knew, 1892–2026 — and why “we don't
        ...
        <ChartFrame
          note={
            <>
              ...
              1892–2026. The pre-1965 points were recovered in 2026 from
