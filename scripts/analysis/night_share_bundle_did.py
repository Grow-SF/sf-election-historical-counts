...
def load_panel(root):
    ...
    # --- untreated / treated-post counts for BJS (spec section 3) ---
...
def real_run(panel, eng, draws, seed, outdir, root):
    ...
    assert asv["nevada_2018_2022"]["rank"] == 2 and \
        asv["nevada_2018_2022"]["n"] == 7
    assert asv["san_diego_2022_2024"]["rank"] == 5 and \
        asv["san_diego_2022_2024"]["n"] == 12
