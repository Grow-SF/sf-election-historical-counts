...
election-night counts back to 1868): 211 elections with an election-night count
(including 105 pre-1965 counts recovered from the hand-count and machine eras,
back to 1868), 355 recovered historical canvass observations, and 241 modern
...
**68 San Francisco elections still lack an election-night count** — see
...
count: **211 recovered · 68 still missing** (20 of the missing at least have a
