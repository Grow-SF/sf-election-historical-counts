...
election-night counts back to 1868): 203 elections with an election-night count
(including 105 pre-1965 counts recovered from the hand-count and machine eras,
back to 1868), 345 recovered historical canvass observations, and 241 modern
...
count: **203 recovered · 17 turnout-only · 55 still missing**. The categories below
