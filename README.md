...
election-night counts back to 1868): 189 elections with an election-night count
(including 104 pre-1965 counts recovered from the hand-count and machine eras,
back to 1868), 303 recovered historical canvass observations, and 241 modern
...
**58 San Francisco elections still lack an election-night count** — see
...
count: **189 recovered · 28 turnout-only · 58 still missing**. The categories below
summarize those 58. (The total rose in July 2026: the Municipal Reports
