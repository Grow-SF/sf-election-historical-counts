...
election-night counts back to 1860): 236 elections with an election-night count
(including 125 pre-1965 counts recovered from the hand-count and machine eras,
back to 1860), 411 recovered historical canvass observations, and 241 modern
...
**52 San Francisco elections still lack an election-night count** — see
...
count: **236 recovered · 52 still missing** (46 of the missing at least have a
known final count; only 6 have no recovered data at all). The categories below
