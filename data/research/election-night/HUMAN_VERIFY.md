...
- [ ] **fresno-ca 2018-11-06** (secondary confidence)
      ...
      controller verdict: CONFIRMED (certified-minus-outstanding derivation self-describing as the state Wednesday morning after election night, bracketed unchanged by the county's own posting schedule)
