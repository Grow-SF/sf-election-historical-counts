...
| 2000-12-12 | HIGH: 38,445 night-partial (ingested, 29.7, night_partial) rests on a citywide-vs-District-6 reading the completion report asked to settle by hand BEFORE ingestion; the review flagged the gap. Operator: open Examiner 2000-12-13 p6 (ProQuest docview 2206415258) and read the sentence 'With 38,445 ballots counted, Daly had won 76 percent to Dittenhafer's 23 percent' in context. If the surrounding text scopes 38,445 to District 6 alone, the row must be withdrawn (a D6-only count cannot be a citywide floor). The supporting arithmetic: nine districts ran runoffs (LAT: two of eleven won outright Nov 7), so districts averaged about 14,400 certified ballots; 38,445 is about 2.7x that average, which supports citywide but does not prove it. No mirror screenshot exists yet (save path failed during capture); recapture is queued | ProQuest docview 2206415258 |
| 2003-12-09 | Examiner editorial: 'processed 246,667 votes on Tuesday' (52.92 percent, arithmetic exact) | if 'on Tuesday' is literal (votes processed by end of election night), re-stamp the ingested day-3 row to election night: a 97.2 percent night share for Newsom-Gonzalez; the editorial's 'in short order' after polls closed supports it, and a DailyKos liveblog of the DOE results page (DaveOinSF, timestamped entries 1:46-2:48am PT) shows '99.11 percent in' by 2:48am, which per the operator's correct reading is the standard PRECINCTS-reporting metric (the thread's own entries show 557/562 to 562/562): it corroborates only that precinct counting completed overnight and is silent on the VBM and provisional piles, which are the crux of whether 246,667 was truly processed by night's end; no hour is printed in the editorial itself | ProQuest docview 2206312937; dailykos.com stories/2003/12/10/4831 |
